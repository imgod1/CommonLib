...
import com.golong.commlib.common.ImageSavaCache;
import com.golong.commlib.encrypt.oneway.MD5Util;
import com.golong.commlib.encrypt.symmetric.AESUtil;
import com.golong.commlib.util.AppUtil;
import com.golong.commlib.util.EncodeUtils;
    ...
    private class AsyncSaveBitmap extends AsyncTask<Void, Void, Void> implements MediaScannerConnection.OnScanCompletedListener {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
                ...
                path= AppUtil.INSTANCE.getExternalCacheDir().getPath();
            }

            final File myDir = new File(path, getFolderName());
            myDir.mkdirs();
