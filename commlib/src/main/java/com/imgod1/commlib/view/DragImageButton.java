...
public class DragImageButton extends AppCompatImageButton {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        isAttach = mTypedAttay.getBoolean(R.styleable.DragImageButton_isAttach, true);
                        ...
                        if (isDrug) {
                            ...
                            if (mLastRawX <= center) {
                                ...
                                this.animate()
                                        ...
                                        .setDuration(500)
                                        .x(ScreenUtil.dip2px(mContext,10f))
                                        .start();
                            } else {
                                //向右贴边
                                this.animate()
                                        .setInterpolator(new BounceInterpolator())
                                        .setDuration(500)
                                        .x(mRootMeasuredWidth - getWidth()- ScreenUtil.dip2px(mContext,10f))
                                        .start();
                            }
                        }
                    }
