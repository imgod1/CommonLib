...
import com.imgod1.commlib.util.DeviceUtil;
...
public class SmoothImageView extends PhotoView {
    ...
    private static int TRANSFORM_DURATION = 200;
    ...
    private float MAX_TRANS_SCALE = 0.39f;
    ...
    private void initTransform() {
        ...
        if (ISFUll){
            ...
            startTransform.top = thumbRect.top - new DeviceUtil(AppUtil.INSTANCE.getApplicationContext()).getStatusBarHeight();
        }
