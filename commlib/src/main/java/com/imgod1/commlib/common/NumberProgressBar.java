...
public class NumberProgressBar extends View {
	...
	public NumberProgressBar(Context context, AttributeSet attrs,
		...
		setProgress(attributes.getFloat(R.styleable.NumberProgressBar_progress, 0f));
...
//			canvas.drawRect(mUnreachedRectF, mUnreachedBarPaint);
			canvas.drawRoundRect(mUnreachedRectF,10f,10f,mUnreachedBarPaint);
		}

		if (mDrawReachedBar) {
//			canvas.drawRect(mReachedRectF, mReachedBarPaint);
			canvas.drawRoundRect(mReachedRectF,10f,10f,mReachedBarPaint);
		}
		if (mIfDrawText) {
